...
<head>
  ...
  <title>Set up your HireAI account</title>
</head>
              ...
              <tr>
                <td style="padding-bottom:30px;">
                  <p style="margin:0;font-size:15px;color:rgba(248,250,252,0.85);line-height:1.75;">
                    An administrator has created a <strong style="color:#fffce5;">HireAI</strong>
                    account for you. To activate it, set your password and verify your
                    email &mdash; then you can sign in and complete your profile.
                  </p>
                </td>
              </tr>
              <tr>
              ...
              <tr>
                <td style="border-top:1px solid rgba(121,164,233,0.22);padding-top:24px;">
                  <p style="margin:0;font-size:12px;color:rgba(248,250,252,0.35);line-height:1.7;">
                    If you weren&rsquo;t expecting this, you can safely ignore this
                    email &mdash; nothing will change on your behalf.
                  </p>
                </td>
              </tr>
            </table>
